...
12. Создаёт nginx vhost и отключает default site.
13. Создаёт скрытые диагностические PHP-файлы и открывает их через товарные URL.
14. Выполняет финальные проверки главной, `/admin/`, БД, Redis и diagnostics.
...
Redis cache is enabled by default:
